 ...
 * @version 2.25
 */
@Name("fixedAssetPurchaseDocumentAction")
@Scope(ScopeType.CONVERSATION)
@BusinessUnitRestrict
public class FixedAssetPurchaseDocumentAction extends GenericAction<PurchaseDocument> {
    ...
    public void initialize() {
        purchaseDocumentAction.setPurchaseOrderAction(fixedAssetPurchaseOrderAction);
    }
