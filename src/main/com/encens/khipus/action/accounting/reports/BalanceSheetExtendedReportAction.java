...
@Name("balanceSheetExtendedReportAction")
@Scope(ScopeType.PAGE)
public class BalanceSheetExtendedReportAction extends GenericReportAction {
    ...
    public void generateReport() {
        ...
        //Double totalPerdidasExcedentes  = totalResults;


        //params.put("perdidasExcedentes", perdidasExcedentes);
        //params.put("totalPerdidasExcedentes", BigDecimalUtil.toBigDecimal(totalPerdidasExcedentes));

        //Double totalPatrimonio = totalPerdidasExcedentes;
        ...
        super.generateReport("balanceSheetReport",
                "/accounting/reports/balanceSheetExtendedReport.jrxml",
    ...
    private void addCriteriaAssetSubReport(String subReportKey, Map mainReportParams) {
        ...
        TypedReportData subReportData = super.generateSubReport(
                subReportKey,
                "/accounting/reports/balanceSheetAssetExtReport.jrxml",
                PageFormat.LETTER,
    ...
    private void addCriteriaLiabilitiesSubReport(String subReportKey, Map mainReportParams) {
        ...
        TypedReportData subReportData = super.generateSubReport(
                subReportKey,
                "/accounting/reports/balanceSheetLiabilitiesExtReport.jrxml",
                PageFormat.LETTER,
                PageOrientation.PORTRAIT,
                createQueryForSubreport(subReportKey, ejbql, Arrays.asList(restrictions), orderBy),
                params);
    ...
    private void addCriteriaCapitalSubReport(String subReportKey, Map mainReportParams) {
        ...
        TypedReportData subReportData = super.generateSubReport(
                subReportKey,
                "/accounting/reports/balanceSheetCapitalExtReport.jrxml",
                PageFormat.LETTER,
                PageOrientation.PORTRAIT,
                createQueryForSubreport(subReportKey, ejbql, Arrays.asList(restrictions), orderBy),
                params);
