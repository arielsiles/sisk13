...
@Name("balanceSheet2ReportAction")
@Scope(ScopeType.PAGE)
public class BalanceSheet2ReportAction extends GenericReportAction {
    ...
    public void generateReport() {
        ...
        params.put("capital_reservastec", new Double(0));
        params.put("capital_ajuste_pat", new Double(0));
        params.put("capital_ajustes_cap", new Double(0));
        params.put("capital_aportes_nocap", new Double(0));
    ...
    private void addCriteriaAssetSubReport(String subReportKey, Map mainReportParams) {
        ...
        TypedReportData subReportData = super.generateSubReport(
                subReportKey,
                "/accounting/reports/balanceSheetAssetReport.jrxml",
                PageFormat.LETTER,
    ...
    private void addCriteriaLiabilitiesSubReport(String subReportKey, Map mainReportParams) {
        ...
        TypedReportData subReportData = super.generateSubReport(
                subReportKey,
                "/accounting/reports/balanceSheetLiabilitiesReport.jrxml",
                PageFormat.LETTER,
                PageOrientation.PORTRAIT,
                createQueryForSubreport(subReportKey, ejbql, Arrays.asList(restrictions), orderBy),
                params);
