 ...
 * @version 2.17
 */
@Name("productItemsForSalesDataModel")
@Scope(ScopeType.PAGE)
public class ProductItemsForSalesDataModel extends QueryDataModel<InventoryPK, Inventory> {
    ...
    private static final String[] RESTRICTIONS =
            {
                    "inventory.warehouse.warehouseType = #{productItemsForSalesDataModel.warehouseType}",
                    ...
                    "lower(inventory.productItem.id.productItemCode) like concat(lower(#{productItemsForSalesDataModel.productItemCode}), '%')",
                    "lower(inventory.productItem.name) like concat('%',concat(lower(#{productItemsForSalesDataModel.productItemName}), '%'))",
