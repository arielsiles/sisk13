...
public class RawMaterialCollectionSession implements com.encens.khipus.model.BaseModel {
    ...
    private com.encens.khipus.model.xproduction.ProductionCollectionState state = com.encens.khipus.model.xproduction.ProductionCollectionState.PENDING;
    ...
    private List<com.encens.khipus.model.xproduction.CollectedRawMaterial> collectedRawMaterialList = new ArrayList<com.encens.khipus.model.xproduction.CollectedRawMaterial>();
    ...
    public com.encens.khipus.model.xproduction.ProductionCollectionState getState() {
        return state;
    }
