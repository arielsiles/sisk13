 ...
 * @author:
 */
@TableGenerator(schema = com.encens.khipus.util.Constants.KHIPUS_SCHEMA, name = "City.tableGenerator",
...
@Table(schema = com.encens.khipus.util.Constants.KHIPUS_SCHEMA, name = "ciudad", uniqueConstraints = {@UniqueConstraint(columnNames = {"idcompania", "iddepartamento", "nombre"})})
