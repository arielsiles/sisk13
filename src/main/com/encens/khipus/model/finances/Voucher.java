 ...
 */
@NamedQueries({
        @NamedQuery(name = "Voucher.findVoucherById", query = "select o from Voucher o WHERE o.id=:id "),
        @NamedQuery(name = "Voucher.findVoucherByNoTrans", query = "select o from Voucher o WHERE o.transactionNumber=:transactionNumber ")
})
