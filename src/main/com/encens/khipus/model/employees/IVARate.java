 ...
 * @version 2.26
 */
@TableGenerator(schema = com.encens.khipus.util.Constants.KHIPUS_SCHEMA, name = "IVARate.tableGenerator",
...
@NamedQueries({
        @NamedQuery(name = "IVARate.findByActiveIVARATE",
                query = "select rate from IVARate rate where rate.active =:active")
})
